...
const FakeColumnsList = [
  {
    ...
    list: [
      {
        title: "task in  backlog 1",
        tags: ["web", "api"],
        assignedTo: [{ name: "Hamdi Gatri", id: 12 }]
      },
      {
        title: "task in  backlog 2",
        tags: ["web"],
        assignedTo: [{ name: "Hamdi Gatri", id: 12 }]
      }
    ]
    ...
    list: [
      {
        title: "completed 1",
        tags: ["DB"],
        assignedTo: [{ name: "Mohamed Aymen Hammemi", id: 12 }]
      }
    ]
  },
  {
...
export const Default = () => (
  <SprintBoard
    columnsList={FakeColumnsList}
    projectMembers={FakeProjectMembers}
  />
);
export default {
  title: "SprintBoard",
